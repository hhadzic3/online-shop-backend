...
function dataInit() {
    ...
    const productsPromiseList = [
        ...
        db.products.create({id: 4,seller_id:2 ,name: 'Shirt Hugo Boss', price: 59 , weight: 1 , description: 'blaaa blaaa',label:"top_rated", stock: 4 }),
        db.products.create({id: 11,seller_id:2 ,name: 'Jacket LV', price: 59 , weight: 1 , description: 'blaaa blaaa',label:"top_rated", stock: 4 }),
        db.products.create({id: 12,seller_id:2 ,name: 'Bag Gucci', price: 59 , weight: 1 , description: 'blaaa blaaa',label:"top_rated", stock: 4 }),
    ...
    const product_categoriesPromiseList = [
        ...
        db.product_categories.create({id: 6,productId:3,categoryId:14}),
        db.product_categories.create({id: 7,productId:4,categoryId:6}),
        db.product_categories.create({id: 8,productId:4,categoryId:13}),
        db.product_categories.create({id: 9,productId:5,categoryId:1}),
        db.product_categories.create({id: 10,productId:5,categoryId:11}),
        db.product_categories.create({id: 11,productId:6,categoryId:4}),
        db.product_categories.create({id: 12,productId:6,categoryId:8}),
    ];
